    ...
    public sealed class Store
    {
        ...
        public List<Dictionary<string, object>> Select(string databaseName, string tableName, List<string> requestedColumns = null)
        {
            ...
            try
            {
                ...
                {
                    // Leer el esquema de la tabla (asumiendo que el esquema est� al inicio del archivo)
                    ...
                    while (stream.Position < stream.Length)
                    {
                        ...
                        // Salir del bucle cuando todas las columnas del esquema se hayan le�do.
                    ...
                    while (stream.Position < stream.Length)
                    {
                        ...
                        {
                            // Si no se solicitaron columnas espec�ficas, agregar la fila completa
                            results.Add(row);
                        }
                    }
                }
        ...
        public OperationStatus InsertIntoTable(string databaseName, string tableName, Dictionary<string, object> rowData)
        {
            ...
            try
            {
                ...
                {
                    // Asegúrate de escribir el ID primero.
        ...
        public OperationStatus DeleteFromTable(string databaseName, string tableName, int idToDelete)
        {
            ...
            try
            {
                string tempFilePath = tablePath + ".tmp"; // Archivo temporal donde se escribirá el nuevo contenido.
                ...
                using (BinaryWriter writer = new BinaryWriter(outputStream))
                {
                    ...
                    if (!found)
                    {
                        ...
                        return OperationStatus.Error; // No se encontró el ID.
                    }
                }
